...
export function IncidentMarker({ incident, getIncidentColor, onClick }: IncidentMarkerProps) {
  ...
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className={`w-10 h-10 rounded-full ${getIncidentColor(incident.urgency)} flex items-center justify-center text-white font-bold border-4 border-white shadow-lg hover:scale-110 transition-transform`}>
        {incident.reports}
      </div>
